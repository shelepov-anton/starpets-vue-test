    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64" fill="none">
        <g clip-path="url(#clip0_6_3078)">
            <path
                ...
                fill="#191977"
                style="fill:#191977;fill:color(display-p3 0.0980 0.0980 0.4667);fill-opacity:1;" />
            <path d="M49.686 5.3333C44.6189 1.966 38.54 0 32 0V5.3333H49.686Z" fill="white"
                  style="fill:white;fill-opacity:1;" />
            <path d="M32 10.6667H55.8453C54.03 8.63897 51.9606 6.84497 49.686 5.33337H32V10.6667Z"
                  fill="#F0263C"
                  style="fill:#F0263C;fill:color(display-p3 0.9412 0.1490 0.2353);fill-opacity:1;" />
            <path d="M32 16H59.7083C58.6024 14.0891 57.3087 12.3013 55.8452 10.6667H31.9999L32 16Z"
                  fill="white" style="fill:white;fill-opacity:1;" />
            <path d="M32 21.3333H62.1719C61.5129 19.4695 60.6847 17.6871 59.7083 16H32V21.3333Z"
                  fill="#F0263C"
                  style="fill:#F0263C;fill:color(display-p3 0.9412 0.1490 0.2353);fill-opacity:1;" />
            <path
                d="M32 26.6667H63.5492C63.2411 24.8312 62.7784 23.0487 62.172 21.3334H32.0001L32 26.6667Z"
                fill="white" style="fill:white;fill-opacity:1;" />
            ...
            <path
                ...
                style="fill:#F0263C;fill:color(display-p3 0.9412 0.1490 0.2353);fill-opacity:1;" />
            <path
                d="M14.314 58.6667H49.6859C51.9605 57.1551 54.0299 55.3611 55.8452 53.3334H8.15466C9.96996 55.3611 12.0394 57.1551 14.314 58.6667Z"
                fill="white" style="fill:white;fill-opacity:1;" />
            <path
                d="M32 64C38.54 64 44.6189 62.0341 49.686 58.6667H14.314C19.3811 62.0341 25.46 64 32 64Z"
                fill="#F0263C"
                style="fill:#F0263C;fill:color(display-p3 0.9412 0.1490 0.2353);fill-opacity:1;" />
            <path
                d="M7.81201 20.6666L5.81201 22.6666L7.81201 24.6666L9.81201 22.6666L7.81201 20.6666Z"
                fill="white" style="fill:white;fill-opacity:1;" />
            <path
                d="M15.6667 20.6666L13.6667 22.6666L15.6667 24.6666L17.6667 22.6666L15.6667 20.6666Z"
                fill="white" style="fill:white;fill-opacity:1;" />
            <path
                d="M23.6667 20.6666L21.6667 22.6666L23.6667 24.6666L25.6667 22.6666L23.6667 20.6666Z"
                fill="white" style="fill:white;fill-opacity:1;" />
            ...
            <path d="M12 25.9999L10 27.9999L12 29.9999L14 27.9999L12 25.9999Z" fill="white"
                  style="fill:white;fill-opacity:1;" />
            <path
                d="M19.8546 25.9999L17.8546 27.9999L19.8546 29.9999L21.8546 27.9999L19.8546 25.9999Z"
                fill="white" style="fill:white;fill-opacity:1;" />
            <path
                d="M27.8546 25.9999L25.8546 27.9999L27.8546 29.9999L29.8546 27.9999L27.8546 25.9999Z"
                fill="white" style="fill:white;fill-opacity:1;" />
            <path d="M12 15.3333L10 17.3333L12 19.3333L14 17.3333L12 15.3333Z" fill="white"
                  style="fill:white;fill-opacity:1;" />
            <path
                d="M19.8546 15.3333L17.8546 17.3333L19.8546 19.3333L21.8546 17.3333L19.8546 15.3333Z"
                fill="white" style="fill:white;fill-opacity:1;" />
            <path
                d="M27.8546 15.3333L25.8546 17.3333L27.8546 19.3333L29.8546 17.3333L27.8546 15.3333Z"
                fill="white" style="fill:white;fill-opacity:1;" />
            <path
                d="M19.8546 4.66663L17.8546 6.66663L19.8546 8.66663L21.8546 6.66663L19.8546 4.66663Z"
                fill="white" style="fill:white;fill-opacity:1;" />
            <path
                d="M27.8546 4.66663L25.8546 6.66663L27.8546 8.66663L29.8546 6.66663L27.8546 4.66663Z"
                fill="white" style="fill:white;fill-opacity:1;" />
            <path
